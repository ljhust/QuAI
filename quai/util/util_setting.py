...
import json
import os
from quai.util.util_localize import setting_path
from quai.util.util_mongo_sql import (
    util_sql_async_mongo_setting,
...
class Setting:
    ...
    @property
    def client(self):
        return util_sql_mongo_setting(self.mongo_uri)

    @property
    def client_async(self):
        return util_sql_async_mongo_setting(self.mongo_uri)
...
SETTING = Setting()
DATABASE = SETTING.client.quantaxis
DATABASE_ASYNC = SETTING.client_async.quantaxis
