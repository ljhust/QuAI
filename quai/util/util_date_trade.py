...
def util_get_next_period(datetime, frequence='1min'):
    '''
    得到给定频率的下一个周期起始时间
...
def util_get_next_trade_date(cursor_date, n=1):
    """
    explanation:
    ...
    cursor_date = util_format_date2str(cursor_date)
    if cursor_date in trade_date_sse:
        # 如果指定日期为交易日
        return util_date_gap(cursor_date, n, "gt")
    real_pre_trade_date = util_get_real_date(cursor_date)
    return util_date_gap(real_pre_trade_date, n, "gt")


def util_get_pre_trade_date(cursor_date, n=1):
    """
    explanation:
        得到前 n 个交易日 (不包含当前交易日)
    ...
    cursor_date = util_format_date2str(cursor_date)
    if cursor_date in trade_date_sse:
        return util_date_gap(cursor_date, n, "lt")
    real_aft_trade_date = util_get_real_date(cursor_date)
    return util_date_gap(real_aft_trade_date, n, "lt")
...
def util_if_tradetime(
    ...
    if market is MARKET_TYPE.STOCK_CN:
        ...
        is_today_open = util_if_trade(date_today)
        is_yesterday_open = util_if_trade(date_yesterday)
...
def util_get_last_datetime(datetime, day=1):
    """
    explanation:
        获取几天前交易日的时间
    ...
    return '{} {}'.format(util_date_gap(date, day, 'lt'), str(datetime)[11:])


def util_get_next_datetime(datetime, day=1):
    date = str(datetime)[0:10]
    return '{} {}'.format(util_date_gap(date, day, 'gt'), str(datetime)[11:])
...
def util_future_to_tradedatetime(real_datetime):
    """
    explanation:
    ...
    if len(str(real_datetime)) >= 19:
        ...
        return dt if dt.time(
                          ...
                          0) else util_get_next_datetime(dt,
                                                            1)
...
def util_future_to_realdatetime(trade_datetime):
    """
    explanation:
    ...
    if len(str(trade_datetime)) == 19:
        ...
        return dt if dt.time(
                          ...
                          0) else util_get_last_datetime(dt,
                                                            1)
